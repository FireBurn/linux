...
kernel::module_usb_driver! {
    ...
    params: {
        ...
        edid_override: u8 {
            default: 0,
            description: "Bitmask of connectors whose EDID the dock cannot read, typically behind a DP-to-HDMI converter that mangles DDC, and which are described by DRM's EDID override instead",
        },
    },
}
