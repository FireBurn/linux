...
mod tests {
    ...
    fn edid_reply_guards() -> Result {
        ...
        let ks = super::SessionKey::new([0u8; 16])?;
        let riv = [0u8; 8];
    ...
    fn get_edid_req_matches_dlm_wire_shape() -> Result {
        ...
        let frame = cp::seal_interactive(
            &cp::SessionKey::new([0x5au8; 16])?,
            &[0x11u8; 8],
            0x15,
            0,
            &req,
    ...
    fn edid_poll_ready_byte_matches_golden_replies() -> Result {
        ...
        let ks = super::SessionKey::new(KS)?;
