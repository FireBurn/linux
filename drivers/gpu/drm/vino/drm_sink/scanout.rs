...
/// sixteen strips a macro-tile holds, which is how a handful of scattered updates used to exhaust
/// the rectangle ceiling and take the whole surface with them.
///
...
impl PixelSource {
    ...
    fn source_px(&self, sx: usize, sy: usize) -> (u16, u16, u16) {
        ...
        match &self.color {
            ...
            // banding is ever measured on a corrected HDR connector; see `docs/hdr.md`.
