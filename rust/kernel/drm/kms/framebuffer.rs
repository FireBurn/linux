...
#[cfg(CONFIG_RUST_DRM_GEM_SHMEM_HELPER)]
pub struct FramebufferVMap<'a, O: gem::DriverObject> {
    map: shmem::VMapRef<'a, O>,
    offset: usize,
    len: usize,
    pitch: usize,
    width: u32,
...
#[cfg(CONFIG_RUST_DRM_GEM_SHMEM_HELPER)]
impl<O: gem::DriverObject> FramebufferVMap<'_, O> {
    ...
    pub fn view(&self) -> SysMem<'_, [u8]> {
        ...
        // SAFETY: `Framebuffer::vmap` checked `offset + len` against the mapped object's size, and
...
mod tests {
    ...
    fn linear_fb(width: u32, height: u32, pitch: u32, offset: u32) -> bindings::drm_framebuffer {
        ...
        // SAFETY: `XRGB888` is a valid DRM fourcc and the returned descriptor has static lifetime.
        fb.format = unsafe { bindings::drm_format_info(crate::drm::fourcc::XRGB888) };
